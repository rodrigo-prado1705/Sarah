...
<p><div align="left">*Impressão de páginas – Imprime a pagina aberta;</div></p>
...
<p><div align="justify">*Alterações: imagine a situação em que o funcionário receba uma promoção e precise alterar suas informações cadastrais, após utilizar da função de pesquisa o empregado é selecionado e tem seu formulário de cadastros habilitado novamente para atualização de seus dados e</div></p>
<p><div align="justify">*Demissão: uma função que caso o contratado seja demitido, calcule os direitos demissionários do mesmo e desative seu registro da empresa.</div></p>
<p><div align="justify">*Incluindo também as funções de abrir links uteis, no seu navegador web para consultas, podendo também imprimir paginas de informações, como por exemplo, lista de empregados de um determinado setor da empresa e até mesmo o envio dessas listas por e-mail, ou de outra informação que ache necessário enviar.</div></p>
